...
export default function DashboardLeadView() {
    return (
        ...
        <Grid container spacing={3}>
            ...
            <Grid xs={12} md={6} lg={8}>
                <AnalyticsConversionRates
                    title="Revenue per BA"
                    subheader="(+43%) than last year"
                    chart={{
                        series: [
                            { label: 'John Doe 1', value: 400 },
                            { label: 'John Doe 2', value: 430 },
                            { label: 'John Doe 3', value: 448 },
                            { label: 'John Doe 4', value: 470 },
                            { label: 'John Doe 5', value: 540 },
                            { label: 'John Doe 6', value: 580 }
                        ],
                    }}
                />
            </Grid>
