...
import { ICampaignTableFilters } from 'src/types/campaign';
...
export default function CampaignReportTableFiltersResult({
  filters,
  onFilters,
  //
  onResetFilters,
  ...
  const handleRemoveType = useCallback(
    (inputValue: string) => {
      const newValue = filters.type.filter((item) => item?.toLowerCase() !== inputValue.toLowerCase());
