...
import BOverviewAnalyticsView from './b-overview-analytics-view';
...
export default function OverviewAnalyticsView() {
    ...
    return (
        <Container maxWidth={settings.themeStretch ? false : 'xl'}>
            ...
            {renderTabs}
            {currentTab === 'sales' && <OverviewEcommerceView />}
            {currentTab === 'competitor' && <BOverviewAnalyticsView />}
            {currentTab === 'user' && <OverviewAppView />}
            {currentTab === 'product' && <BOverviewAnalyticsView />}
