...
const CFormCampaignDetails = lazy(() => import("./forms/c-form-campaign-details"));
const CFormCampaignProducts = lazy(() => import("./forms/c-form-campaign-products"));
const CFormCampaignRegions = lazy(() => import("./forms/c-form-campaign-regions"));
const CFormCampaignTeams = lazy(() => import("./forms/c-form-campaign-teams"));
