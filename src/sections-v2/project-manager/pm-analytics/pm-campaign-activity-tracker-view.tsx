...
import PMCampaignActivityTracker from './campaign/pm-campaign-activity-tracker';
...
export default function PMCampaignActivityTrackerView() {
  ...
  useEffect(() => {
    if (client?._id) {
      ...
      setError(null);
      realmApp.currentUser?.functions.searchPMCampaigns({ client_id: client?._id.toString(), searchString: debouncedSearch }).then((data: ICampaign[]) => setSearchedCampaigns(data))
        .catch(e => {
          console.error(e)
          setError(e);
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'xl'}>
      ...
      <Box>
        ...
        {currentTab === "active" && selectCampaign && !showCampaignLoading && <PMCampaignActivityTracker campaign={selectCampaign} />}
