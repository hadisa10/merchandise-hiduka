...
import PMCampaignSalesInventoryView from './campaign/pm-campaign-sales-inventory';
...
export default function PMCampaignPerformaceView() {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'xl'}>
      ...
      {currentTab === "sales" && selectCampaign && !showCampaignLoading && <PMCampaignSalesInventoryView campaign={selectCampaign} />}
