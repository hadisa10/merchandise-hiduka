...
const CFormCampaignDetails = lazy(() => import("./forms/pm-form-campaign-details"));
const CFormCampaignProducts = lazy(() => import("./forms/pm-form-campaign-products"));
const CFormCampaignRegions = lazy(() => import("./forms/pm-form-campaign-regions"));
const CFormCampaignTeams = lazy(() => import("./forms/pm-form-campaign-teams"));
